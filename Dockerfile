...
# RUN python3.9 -m venv venv && source venv/bin/activate && pip3 install ray[client] torch torchvision
# RUN python3.9 -m venv venv && source venv/bin/activate && pip3 install ray[client] tensorflow keras
RUN python3.9 -m venv venv && source venv/bin/activate && pip3 install ray[client] 
